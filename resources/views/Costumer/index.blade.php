        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="float-end"><a href="/costumer/tambah" class="btn btn-primary btn-sm"><i class="fa-solid fa-user-plus"></i> Tambah Data</a></div>
                            ...
                            @forelse ( $dosen as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/costumer/edit/{{$data->id}}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                Yakin Data Costumer a.n. {{$data->nama}} ingin dihapus?
                                            </div>
